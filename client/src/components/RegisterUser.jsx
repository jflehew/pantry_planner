            ...
            <div className="form-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <div className="error-container">
                            {usedInput.confirmPassword && !confirmPassword && (
                                <p>Your passwords must match</p>
                            )}
                            {serverErrors && (
                                <p>{serverErrors.confirmPassword}</p>
                            )}
                        </div>
                    </div>
                    <button
